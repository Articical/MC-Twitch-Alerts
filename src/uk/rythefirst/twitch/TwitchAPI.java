...
public class TwitchAPI {
	...
	// TODO: Change getUrlAsString to run async
				...
				try {
					...
					new BukkitRunnable() {
						...
						public void run() {
							...
							try {
								...
								TwitchInfo tInf = isLive(Main.twitchname);
					...
					if (info.isLive() == true && Live == false) {
						...
						for (Player player : Bukkit.getServer().getOnlinePlayers()) {
							...
							Messages.sendCenteredMessage(player,
									"" + ChatColor.DARK_PURPLE + ChatColor.BOLD + Main.servername);
							Messages.sendCenteredMessage(player, "");
							Messages.sendCenteredMessage(player,
									"" + ChatColor.DARK_PURPLE + ChatColor.BOLD + Main.twitchname + " is now live!");
							Messages.sendCenteredMessage(player,
									"" + ChatColor.DARK_PURPLE + "@ https://www.twitch.tv/" + Main.twitchname);
